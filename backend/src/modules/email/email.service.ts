...
<img src="https://frontend-eosin-seven-71.vercel.app/logo.png" alt="LevelFITness" width="48" height="48" style="border-radius:12px"/>
<h1 style="color:#f4f4f5;font-size:24px;font-weight:800;margin:20px 0 8px;letter-spacing:-0.5px">Welcome to LevelFITness</h1>
...
<p style="color:#52525b;font-size:12px;margin:0;text-align:center">LevelFITness &mdash; Intelligent coaching for serious athletes</p>
</td></tr>
</table>
</td></tr>
</table>
...
<p style="color:#a1a1aa;font-size:15px;line-height:1.6;margin:0 0 24px">${inviterName} has invited you to join LevelFITness. Accept the invite to get started.</p>
...
export async function sendWelcomeEmail(email: string, firstName: string): Promise<void> {
  ...
  await t.sendMail({
    from: env.SMTP_FROM,
    to: email,
    subject: "Welcome to LevelFITness",
...
export async function sendInviteEmail(email: string, inviterName: string, acceptUrl: string): Promise<void> {
  ...
  await t.sendMail({
    from: env.SMTP_FROM,
    to: email,
    subject: `${inviterName} invited you to LevelFITness`,
