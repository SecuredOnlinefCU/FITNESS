    ...
    return (
      <Card className="w-full max-w-sm">
        <CardContent className="p-8 text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-signal/20">
            <svg className="h-6 w-6 text-signal" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
          ...
          <Link
            href="/login"
            className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-foreground hover:text-signal transition-colors"
          >
            <ArrowLeft size={16} />
            Back to log in
          </Link>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4" noValidate>
          ...
          <div>
            ...
            <Input
              ...
              required
              aria-required="true"
              aria-describedby={error && !email ? 'forgot-error' : undefined}
            />
          </div>
