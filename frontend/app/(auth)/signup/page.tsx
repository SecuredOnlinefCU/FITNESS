      ...
      <div className="rounded-3xl border border-border bg-card p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4" noValidate>
          ...
          <div className="space-y-4 sm:grid sm:grid-cols-2 sm:gap-3 sm:space-y-0">
            ...
            <div>
              <label htmlFor="signup-last" className="mb-1.5 block text-sm font-bold text-foreground">Last name</label>
              <input
                id="signup-last"
                name="lastName"
                type="text"
          ...
          <div>
            <label htmlFor="signup-confirm" className="mb-1.5 block text-sm font-bold text-foreground">Confirm password</label>
            <input
              id="signup-confirm"
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <Link href="/terms" className="font-semibold text-foreground underline-offset-2 hover:underline">Terms of Service</Link>{' '}
            and{' '}
            <Link href="/privacy" className="font-semibold text-foreground underline-offset-2 hover:underline">Privacy Policy</Link>.
          </p>
