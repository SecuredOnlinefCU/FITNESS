    ...
    <ProtectedRoute roles={['client', 'super_admin']}>
      <DashboardShell>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card><CardContent><h2 className="font-bold">Body metrics</h2><p className="mt-1 text-sm text-muted-foreground">This section is ready for API-driven data.</p></CardContent></Card>
