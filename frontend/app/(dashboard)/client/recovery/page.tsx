      ...
      <DashboardShell>
        ...
        <Card className="relative overflow-hidden border-flow/20">
          ...
          <CardContent className="p-6">
            ...
            <div className="mt-4 inline-flex rounded-full bg-muted px-4 py-2 text-sm font-bold text-muted-foreground">No device connected</div>
          </CardContent>
        </Card>
        ...
        <div className="mt-5 grid gap-5 md:grid-cols-[1.2fr_0.8fr]">
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-6xl font-black tracking-tight md:text-7xl">--<span className="text-3xl text-muted-foreground">%</span></p>
              <p className="mt-2 text-muted-foreground">Connect a wearable to see your daily readiness score based on sleep, HRV, and recovery signals.</p>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black">--h</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black">-- bpm</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent className="p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-black">-- ms</p>
                </div>
              </div>
            </CardContent>
          </Card>
