              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black">{metrics.data?.items?.length ?? 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black">{photos.data?.items?.length ?? 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black">{checkins.data?.items?.length ?? 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
